...
#
# Template variables:
#   llmtemplate - replaced with project name during installation
#   /bin/bash   - replaced with path to real shell (e.g., /bin/bash)
...
LOG_FILE="$LOG_DIR/llmtemplate_audit.log"
